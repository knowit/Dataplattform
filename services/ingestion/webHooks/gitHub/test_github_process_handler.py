...
def test_data_poller():
    with open(path.join(path.dirname(__file__), 'test_process_poller_data.json'), 'r') as json_file:
        yield load(json_file)


@fixture
def test_data_webhook():
    with open(path.join(path.dirname(__file__), 'test_process_webhook_data.json'), 'r') as json_file:
        yield load(json_file)
