...
def ingest(event) -> Data: 
    def fetch_github_data(url):
        ...
        def convert_ISO8601_to_timestamp(time_str): # TODO: Make a library perhaps? 
                                                #Could include time_to_posix from yr_poller
...
@handler.process(partitions={'github_knowit_repos': ['id','name','time'], \
                              'github_knowit_repo_status':['id','updated_at','pushed_at','time']}) 
