...
def test_process_data_table_created(create_table_mock, setup_queue_event, test_data):
...
def test_process_parquet_get_data(create_table_mock, setup_queue_event, test_data):
    tmp_data = test_data['data']
